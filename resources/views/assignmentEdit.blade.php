...
<div class="container">
    ...
    <div class="container border">
        ...
        <form method="POST" action="{{ route('assignment.update', $assignment->id) }}">
            ...
            <input type="text" id="asgn-name" name="name" placeholder="Name" style="outline: 0; border-width: 0 0 2px; border-color: gray; width:100%; margin:15px 0 15px 0" value="{{ $assignment->name }}">
